export default {
  ...
  appleShortcuts: {
    ...
    tokenWarning: 'Click below to copy your token. Keep it secret.',
    ...
    step3: 'Tap the new Token to copy it to your clipboard. Keep it secure.',
    ...
    step7: 'Search for and add the "Get Contents of URL" action. Paste this exact URL: [API_URL]/integrations/shortcut/accounts',
    step8: 'In the URL action, click the arrow (>) to expand options. Under "Headers", tap "Add new header". For Key type "Authorization". For Text type "Bearer " (with a space) then paste your Token.',
    step9: 'Search for and add the "Choose from List" action. It will automatically connect to "Contents of URL".',
    step10: 'This will display your account names. When you select one, it outputs the chosen Name.',
    step11: 'Add action "Get Dictionary Value". For the Key, select the variable "Chosen Item". For the Dictionary, select the "Contents of URL" variable (from step 7). This gets your accountId secretly!',
    step12: 'Add another "Get Contents of URL" action. Set the URL to: [API_URL]/integrations/shortcut/categories. Repeat Step 8 to add your Authorization header.',
    step13: 'Add another "Choose from List" action. Ensure it connects to the new "Contents of URL".',
    step14: 'This will display your category names. When you select one, it outputs the chosen Name.',
    step15: 'Add action "Get Dictionary Value". For the Key, select the variable "Chosen Item". For the Dictionary, select the "Contents of URL" variable (from step 12).',
    step16: 'Add a "Text" action. Inside it, insert the "Current Date" variable. Tap on it, set Date Format to "Custom", and type: yyyyMMddHHmmssSSS',
    step17: 'Add a final "Get Contents of URL" action. Set the URL to: [API_URL]/integrations/shortcut/transactions',
    step18: 'Expand the action (>). Tap "Method" and change it from GET to POST.',
    step19: 'Under "Headers", add the Authorization header exactly like you did in Step 8.',
    step20: 'Add a second header. For Key type "Idempotency-Key". For Text, insert the "Text" variable from Step 16.',
    step21: 'Scroll down to "Request Body" and change it to "JSON".',
    step22: 'Tap "Add new field" > "Number". For Key type "amount", and for the value insert the "Provided Input" variable (from step 6).',
    step23: 'Tap "Add new field" > "Text". For Key type "accountId", and for the value insert the "Dictionary Value" variable (from step 11).',
    step24: 'Tap "Add new field" > "Text". For Key type "categoryId", and for the value insert the "Dictionary Value" variable (from step 15).',
    step25: 'Add a "Show Notification" action at the very end and write "Transaction Saved!". (Apple Shortcuts will automatically halt and show an error if it fails).',
    step26: 'Tap "Done" to save your Shortcut. Now, open your iPhone Settings app.',
    step27: 'Go to Accessibility > Touch > Back Tap (scroll to the very bottom).',
    step28: 'Choose "Double Tap", scroll down to the "Shortcuts" section, and select your Finova shortcut.',
