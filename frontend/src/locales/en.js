export default {
  ...
  appleShortcuts: {
    ...
    step10: 'This action will display your account names. When you select one, it outputs the chosen Name.',
    step11: 'Add another "Get Contents of URL" action. Set the URL to: [API_URL]/integrations/shortcut/categories. Repeat Step 8 to add the Authorization header.',
    step12: 'Add another "Choose from List" action, making sure it links to the new "Contents of URL".',
    step13: 'This will display your category names. When you select one, it outputs the chosen Name.',
    ...
    step15: 'Add a "Get Contents of URL" action. Set the URL to exactly: [API_URL]/integrations/shortcut/transactions',
    ...
    step18: 'Add a second header. For Key type "Idempotency-Key". For Text, insert the "Text" variable from Step 14.',
    ...
    step23: 'Add a "Show Result" action at the very end and select the "Contents of URL" variable. This will show you the exact response from the server so you can be sure it was saved!',
