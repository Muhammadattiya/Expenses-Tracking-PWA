export default {
  ...
  appleShortcuts: {
    ...
    step1: 'Open Finova Settings (this page).',
    step2: 'Generate the Shortcut token above if you haven\'t already.',
    step3: 'Copy the token and keep it secure.',
    ...
    step11: 'Add action: "Get Dictionary Value" to extract the "id" from the Chosen Item. Preserve this selected accountId.',
    step12: 'Add action: "Get Contents of URL" and set URL to [API_URL]/categories (Add the same Authorization header).',
    step13: 'Add action: "Get Dictionary from Input" for the categories response.',
    step14: 'Add action: "Choose from List". (This will show your category names).',
    step15: 'Add action: "Get Dictionary Value" to extract the "id" from the Chosen Item. Preserve this selected categoryId.',
    step16: 'Add action: "Get text from input" and use the magic variable "Current Date" (Custom format: UUID or generate a unique string) to create a NEW UUID for this execution.',
    step17: 'Add action: "Get Contents of URL" and set URL to [API_URL]/transactions.',
    step18: 'Set the Method to POST.',
    step19: 'In Headers, add Key = Authorization, Value = Bearer [Your_Copied_Token].',
    step20: 'In Headers, add Key = Idempotency-Key, Value = [The UUID generated in step 16].',
    step21: 'In the POST body, select JSON.',
    step22: 'Add 3 body fields: amount = Provided Input, accountId = accountId (from step 11), categoryId = categoryId (from step 15).',
    step23: 'Add action: "If" to handle success (check if URL Contents contains "Transaction created").',
    step24: 'Add action: "Show Notification" (Transaction saved!) for the success case.',
    step25: 'Add action: "Show Alert" (Error saving transaction) for the failure case.',
    step26: 'Save the shortcut. Open your iPhone Settings.',
    step27: 'Navigate to Accessibility > Touch > Back Tap.',
    step28: 'Select "Double Tap" or "Triple Tap" and assign your new Finova shortcut.',
