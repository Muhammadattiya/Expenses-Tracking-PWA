    ...
    >
      ...
      >
        <div className="space-y-4">
          <div>
            <label htmlFor="login-email" className="mb-1.5 block text-sm font-medium text-white/90 px-2 drop-shadow-sm">
              {t('auth.email')}
            </label>
            <input 
              id="login-email"
          ...
          <div>
            <label htmlFor="login-password" className="mb-1.5 block text-sm font-medium text-white/90 px-2 drop-shadow-sm">
              {t('auth.password')}
            </label>
