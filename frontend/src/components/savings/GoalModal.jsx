...
export default function GoalModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-4 bg-black/70 backdrop-blur-md">
      ...
      >
        {/* Header */}
        <div className="p-6 border-b border-white/10 flex items-center justify-between shrink-0 sticky top-0 bg-[#1A1617]/95 backdrop-blur-md z-20">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 id="goal-modal-title" className="text-lg font-bold text-white">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          <div className="overflow-y-auto p-6 space-y-4 max-h-[calc(90vh-170px)]">
            {error && (
            ...
            {/* Goal Title */}
            <div>
              <label htmlFor="goal-title-input" className="block text-xs font-semibold text-white/70 mb-1.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label htmlFor="goal-target-amount" className="block text-xs font-semibold text-white/70 mb-1.5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5 min-h-[18px]">
                  <label htmlFor="goal-current-amount" className="block text-xs font-semibold text-white/70">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label htmlFor="goal-target-date" className="block text-xs font-semibold text-white/70 mb-1.5">
              ...
              <div>
                <label htmlFor="goal-priority-select" className="block text-xs font-semibold text-white/70 mb-1.5">
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-3">
              ...
              <div>
                <label htmlFor="goal-linked-account" className="block text-[11px] font-semibold text-white/60 mb-1">
                  {allocationType === 'dedicated' 
            ...
            {/* Notes */}
            <div>
              <label htmlFor="goal-notes-input" className="block text-xs font-semibold text-white/70 mb-1.5">
          ...
          <div className="sticky bottom-0 bg-[#1A1617]/95 backdrop-blur-md p-6 pt-3 pb-5 border-t border-white/10 z-20">
            <motion.button
              whileTap={{ scale: 0.98 }}
              type="submit"
              disabled={isSaving}
