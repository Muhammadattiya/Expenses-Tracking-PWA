...
import { LayoutDashboard, PlusCircle, TrendingUp, Settings, User } from 'lucide-react';
...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-4 z-50">
      <div className="bg-black/40 backdrop-blur-2xl border border-white/10 rounded-3xl p-2 flex justify-around items-center shadow-[0_-8px_30px_rgb(0,0,0,0.12)]">
