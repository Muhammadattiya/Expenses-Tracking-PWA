        ...
        return (
          <>
            <div className="space-y-1">
              ...
              <input required type="number" step="0.01" className="w-full bg-white/5 border border-white/10 rounded-xl py-2 px-3 text-white/90 focus:border-[#8D6346] focus:ring-1 focus:ring-[#8D6346] outline-none" onChange={e => setPayload({...payload, amount: e.target.value})} />
            </div>
            <div className="space-y-1">
        ...
        return (
          <>
            <div className="space-y-1">
              ...
              <input required type="number" step="0.01" className="w-full bg-white/5 border border-white/10 rounded-xl py-2 px-3 text-white/90 focus:border-[#8D6346] focus:ring-1 focus:ring-[#8D6346] outline-none" onChange={e => setPayload({...payload, newAmount: e.target.value})} />
            </div>
            <div className="space-y-1">
        ...
        return (
          <>
            <div className="space-y-1">
              ...
              <select className="w-full bg-[#1C1819] border border-white/10 rounded-xl py-2 px-3 text-white/90 focus:border-[#8D6346] outline-none" onChange={e => setPayload({...payload, action: e.target.value})}>
            ...
            <div className="space-y-1">
              <label className="text-xs text-[var(--color-text-muted)] font-medium">Amount</label>
              <input required type="number" step="0.01" className="w-full bg-white/5 border border-white/10 rounded-xl py-2 px-3 text-white/90 focus:border-[#8D6346] outline-none" onChange={e => setPayload({...payload, amount: e.target.value})} />
            </div>
          </>
        );
      case 'debt':
          ...
          <>
            ...
            {payload.action !== 'add' && (
              <div className="space-y-1">
                ...
                <select className="w-full bg-[#1C1819] border border-white/10 rounded-xl py-2 px-3 text-white/90 focus:border-[#8D6346] outline-none" onChange={e => setPayload({...payload, billId: e.target.value})}>
         ...
         return (
          <>
            ...
            <div className="space-y-1">
              ...
              <select className="w-full bg-[#1C1819] border border-white/10 rounded-xl py-2 px-3 text-white/90 focus:border-[#8D6346] outline-none" onChange={e => setPayload({...payload, recurringId: e.target.value})}>
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="bg-[#1C1819] w-full max-w-md rounded-3xl border border-white/10 shadow-2xl relative z-10 animate-scale-in flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 border-t border-white/5 flex gap-3">
          <button type="button" onClick={onClose} className="flex-1 py-3.5 bg-white/5 hover:bg-white/10 rounded-full font-bold text-[15px] text-white transition-colors border border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.35),inset_0_1px_1px_rgba(255,255,255,0.18)]">
            Cancel
          </button>
          <button type="submit" form="sim-form" className="flex-[2] py-3.5 rounded-full font-bold text-[15px] text-white shadow-[0_4px_20px_rgba(0,0,0,0.35),inset_0_1px_1px_rgba(255,255,255,0.18)] transition-all duration-300 active:scale-[0.98] bg-[#8D6346]/30 border border-[#8D6346]/50 hover:bg-[#8D6346]/45 hover:border-[#8D6346]/70 flex items-center justify-center gap-2 backdrop-blur-md">
