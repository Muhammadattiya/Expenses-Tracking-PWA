    ...
    <div className="flex-1 flex flex-col w-full min-h-0 py-1 px-4 sm:px-6 relative z-10 items-center justify-between" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="flex-1 min-h-0 flex flex-col items-center justify-center relative w-full py-1">
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-[310px] h-[240px] bg-[#2B2321]/45 backdrop-blur-[32px] border border-white/15 rounded-[2.2rem] shadow-[0_16px_48px_rgba(0,0,0,0.6),inset_0_1px_2px_rgba(255,255,255,0.2)] overflow-hidden flex flex-col justify-between"
        >
          {/* Ambient Glow */}
