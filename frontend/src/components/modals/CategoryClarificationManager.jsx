      ...
      <AnimatePresence>
        {!isModalOpen && activeCategory && !dockOverlay && (
          <motion.div
            ...
            className="fixed top-[max(0.75rem,env(safe-area-inset-top))] end-3 sm:end-8 z-[90] liquidglass cursor-pointer overflow-hidden border border-white/10 shadow-xl max-w-[min(16rem,calc(100vw-5.5rem))]"
