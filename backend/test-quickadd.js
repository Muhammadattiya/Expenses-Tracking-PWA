...
const tests = [
  ...
  { input: 'جبت أكل بـ100', expectAmount: 100, expectIntent: 'food', expectDate: 'today', expectDesc: 'أكل', expectAccount: null },
  ...
  { input: 'ركبت تاكسي بـ100', expectAmount: 100, expectIntent: 'taxi', expectDate: 'today', expectDesc: 'تاكسي', expectAccount: null },
  { input: 'دفعت 150 في Uber', expectAmount: 150, expectIntent: 'ride_hailing', expectDate: 'today', expectDesc: 'Uber', expectAccount: null },
  { input: 'دفعت 100 امبارح في تاكسي', expectAmount: 100, expectIntent: 'taxi', expectDate: 'yesterday', expectDesc: 'تاكسي', expectAccount: null },
  { input: 'I spent 100 yesterday on a taxi', expectAmount: 100, expectIntent: 'taxi', expectDate: 'yesterday', expectDesc: 'a taxi', expectAccount: null },
  ...
  { input: 'النهارده جبت اكل بـ100', expectAmount: 100, expectIntent: 'food', expectDate: 'today', expectDesc: 'اكل', expectAccount: null },
